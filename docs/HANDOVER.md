...
**ユーザー対応待ち**: ①5-5 iPhone実機でカメラ撮影テスト
②マニュアル2冊（docs/マニュアル/）の内容確認・配布（2026-07-12改訂済み: メール提出の章を稼働済み表記に更新・
提出先 hub@dosl.co.jp と件名ルールを記載。改訂前の版は docs/マニュアル/.backup_20260712/）
